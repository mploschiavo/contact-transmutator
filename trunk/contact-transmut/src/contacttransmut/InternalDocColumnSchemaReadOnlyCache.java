...
/**
 * Cached read-only layer for InternalDocColumnSchema to improve performance.
 * @author Jakub Svoboda
 */
public class InternalDocColumnSchemaReadOnlyCache implements InternalDocColumnSchema  {

    private InternalDocColumnSchema origSchema;
    private HashMap<Integer, String> candidatetypes = new HashMap<Integer, String>();
    private HashMap<Integer, String> selectedtypes = new HashMap<Integer, String>();
    private HashMap<Integer, Boolean> ismergedcolumn = new HashMap<Integer, Boolean>();
    private HashMap<Integer, Boolean> isaggregatedcolumn = new HashMap<Integer, Boolean>();



    public InternalDocColumnSchemaReadOnlyCache(InternalDocColumnSchema newOriginalSchema) {
        origSchema = newOriginalSchema.returnClonedColumnSchema();
        Integer howmanycolumns = origSchema.getColumnCount();
        for (Integer i=0; i<=howmanycolumns; i++) {
            candidatetypes.put(i, origSchema.queryCandidateType(i)) ;
            selectedtypes.put(i, origSchema.querySelectedtypeType(i));
            ismergedcolumn.put(i, origSchema.isColumnMergedInOther(i));
            isaggregatedcolumn.put(i, origSchema.isColumnAggregated(i));
        }
        ...
        public InternalDocColumnSchema returnClonedColumnSchema() {
            InternalDocColumnSchema newSchema = new InternalDocColumnSchemaReadOnlyCache(origSchema);
            return newSchema;
        }
    ...
    public boolean isColumnMergedInOther(Integer colNumber) {
        return ismergedcolumn.get(colNumber);
    }
    ...
    public boolean isColumnAggregated(Integer colNumber) {
        return isaggregatedcolumn.get(colNumber);
    }
    ...
    public String queryAggregateSettingDelimiter(Integer colNum) {
        return origSchema.queryAggregateSettingDelimiter(colNum);
    }
    ...
    public Integer queryAggregateSettingNumberofcolumns(Integer colNum) {
        return origSchema.queryAggregateSettingNumberofcolumns(colNum);
    }
    ...
    public boolean queryAggregateSettingIntoseparatecontacts(Integer colNum) {
        return origSchema.queryAggregateSettingIntoseparatecontacts(colNum);
    }
    ...
    public boolean queryAggregateSettingEmployees(Integer colNum) {
        return origSchema.queryAggregateSettingEmployees(colNum);
    }
    ...
    public boolean queryAggregateSettingOriginalsourcenote(Integer colNum) {
        return origSchema.queryAggregateSettingOriginalsourcenote(colNum);
    }
    ...
    public boolean queryAggregateSettingOriginaltargetnote(Integer colNum) {
        return origSchema.queryAggregateSettingOriginaltargetnote(colNum);
    }
    ...
    public String queryAggregateSettingSeparatecontactsdelimiter(Integer colNum) {
        return origSchema.queryAggregateSettingSeparatecontactsdelimiter(colNum);
    }
    ...
    public boolean queryAggregateSettingAutodetectswaps(Integer colNum) {
        return origSchema.queryAggregateSettingAutodetectswaps(colNum);
    }
    ...
    public Integer queryMergeSet(Integer colNum) {
        return origSchema.queryMergeSet(colNum);
    }
    ...
    public Integer queryMergeOrder(Integer colNum) {
        return origSchema.queryMergeOrder(colNum);
    }
    ...
    public String queryMergesetCandidateType(Integer mergesetNum) {
        return origSchema.queryMergesetCandidateType(mergesetNum);
    }
    ...
    public String queryMergesetSelectedType(Integer mergesetNum) {
        return origSchema.queryMergesetSelectedType(mergesetNum);
    }
    ...
    public String queryMergesetDelimiter(Integer mergesetNum) {
        return origSchema.queryMergesetDelimiter(mergesetNum);
    }
    ...
    public String queryCandidateType(Integer colNum) {
        return candidatetypes.get(colNum);
    }
    ...
    public String querySelectedtypeType(Integer colNum) {
        return selectedtypes.get(colNum);
    }
    ...
    public String queryAggregatedCandidateType(Integer colNum, Integer colNum2) {
        return origSchema.queryAggregatedCandidateType(colNum, colNum2);
    }
    ...
    public String queryAggregatedSelectedtypeType(Integer colNum, Integer colNum2) {
        return origSchema.queryAggregatedSelectedtypeType(colNum, colNum2);
    }
    ...
    public ArrayList<Integer> getAllMergesets() {
        return origSchema.getAllMergesets();
    }
    ...
    public HashMap<Integer, Integer> getAllMergesetMembers(Integer mergeset) {
        return origSchema.getAllMergesetMembers(mergeset);
    }
    ...
    public int getColumnCount() {
        return origSchema.getColumnCount();
    }
    ...
    public boolean isTypeInColumnSchema(VCFTypesEnum type) {
        return origSchema.isTypeInColumnSchema(type);
    }
